...
class ProjectsApi(object):
    ...
    def add_project(self, body, **kwargs):  # noqa: E501
        ...
        :param Projects body: Create new project (required)
        :return: int
    ...
    def delete_project_by_id(self, project_id, **kwargs):  # noqa: E501
        """Delete project with specified ID  # noqa: E501

        Delete a single project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_project_by_id(project_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int project_id: ID of project to delete (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_project_by_id_with_http_info(project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_project_by_id_with_http_info(project_id, **kwargs)  # noqa: E501
            return data

    def delete_project_by_id_with_http_info(self, project_id, **kwargs):  # noqa: E501
        """Delete project with specified ID  # noqa: E501

        Delete a single project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_project_by_id_with_http_info(project_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_project_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `delete_project_by_id`")  # noqa: E501
    ...
    def get_project_by_id(self, project_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int project_id: ID of project to return (required)
        :return: Projects
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def overwrite_project_by_id(self, body, project_id, **kwargs):  # noqa: E501
        """Overwrite project with specified ID  # noqa: E501

        Fully overwrite project with specified ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.overwrite_project_by_id(body, project_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Projects body: (required)
        :param int project_id: ID of project to update (required)
        :return: Projects
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.overwrite_project_by_id_with_http_info(body, project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.overwrite_project_by_id_with_http_info(body, project_id, **kwargs)  # noqa: E501
            return data

    def overwrite_project_by_id_with_http_info(self, body, project_id, **kwargs):  # noqa: E501
        """Overwrite project with specified ID  # noqa: E501

        Fully overwrite project with specified ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.overwrite_project_by_id_with_http_info(body, project_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method overwrite_project_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `overwrite_project_by_id`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `overwrite_project_by_id`")  # noqa: E501
    ...
    def projects_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[Projects]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
